$(function(){
	...
	function load_combogrid_product(){
		$('#dg').datagrid({
			toolbar: '#tbar',
		    url: extras_Hosting["tomcatSpring_context"]+'ad/ProductTransController/get_json_append_to_datagrip.json',
		    //width:600,
		   // height:300,
		   // fitColumns:true,
		    idField:'product_id',
		    ...
		    columns:[[
		        ...
		        {field:'lang_code',title:'Language',width:80,halign:'left',sortable:true},
		        {field:'product_id',title:'Product ID',width:150,halign:'left',sortable:true},
		       ...
		       // {field:'product_description',title:'Description',width:280,halign:'center',align:'center',sortable:true},
		        {field:'product_price',title:'Price',width:100,halign:'center',align:'right',sortable:true},
		        {field:'seller_id',title:'Seller',width:200,halign:'center',align:'right',sortable:true}
		    ]],
		    pagination:true
		});
	}
	...
	function load_mm_selector(callback){
		$("#mm").html('');   	
		var pdata={'pcdtype':'PROTRANS','pcdname':'SEARCH'};
	...
	function create_panel(id,tabtitle){
		$.get(extras_Hosting["apache"] +"admin/views/Translator/NonTrans/detailedit.html",function(data){
			if(data!=null){

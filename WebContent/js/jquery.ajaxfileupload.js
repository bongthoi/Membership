        ...
        return this.each(function() {
          ...
          var upload_file = function()
          {
            ...
            if(true === settings.validate_extensions && $.inArray(ext, settings.valid_extensions) == -1)
            {
              ...
              settings.onComplete.apply($element, [{status: false, message: '选择档案格式无效。档案必须是 ' + settings.valid_extensions.join(', ') + '.'}, settings.params]);
            } else
            { 
              uploading_file = true;
          ...
          */
          var handleResponse = function(loadedFrame, element) {
            ...
            settings.onComplete.apply(element, [{pram:response,status: true, message: '您的档案已上传!'} , settings.params]);
          };
